(function () {
    const translations = {
        ...
        es: {
            ...
            "title.main": "SwingPuzzles - Tu acertijo diario de 1 minuto",
            "hero.mascotAlt": "Mascota de SwingPuzzles",
            "hero.heading": "Tu dato y acertijo diario de 1 minuto",
            "hero.subheading": "Primero un dato corto y sorprendente, luego un pequeño acertijo relacionado. Un reinicio mental rápido para tu día.",
            "hero.primaryCta": "Quiero el dato y el acertijo de hoy",
            "hero.note": "Gratis. Sin spam. Puedes darte de baja cuando quieras.",
            "form.heading": "Recibe hoy tu primer dato con acertijo",
            ...
            "form.submitCta": "Envíame el dato y el acertijo de hoy",
            "form.gdprNote": "Cuando confirmes tu correo, empezarás a recibir correos diarios o semanales con datos y acertijos de SwingPuzzles. Puedes darte de baja en cualquier momento.",
            "video.heading": "Míralo en 30 segundos",
            "video.fallback": "Tu navegador no es compatible con el elemento de vídeo.",
            "video.caption": "Un ejemplo: primero un dato curioso en pantalla y después un pequeño acertijo para resolver.",
            "video.cta": "Quiero el dato y el acertijo de hoy",
            ...
            "steps.2.title": "Resuelves un pequeño acertijo sobre ese dato",
            "steps.2.body": "Un reto rápido conectado con lo que acabas de leer, para que el dato se te quede mejor y sea más divertido.",
            ...
            "finalCta.primaryCta": "Quiero el dato y el acertijo de hoy",
            "footer.brand": "SwingPuzzles",
        ...
        fr: {
            ...
            "title.main": "SwingPuzzles – Ton énigme quotidienne d’1 minute",
            "hero.mascotAlt": "Mascotte SwingPuzzles",
            "hero.heading": "Ton fait du jour avec une énigme en 1 minute",
            "hero.subheading": "D’abord un fait court et étonnant, puis une petite énigme liée. Un reset mental rapide pour ta journée.",
            "hero.primaryCta": "Recevoir le fait et l’énigme d’aujourd’hui",
            "hero.note": "Gratuit. Pas de spam. Désinscription à tout moment.",
            "form.heading": "Reçois aujourd’hui ton premier fait + énigme",
            ...
            "form.submitCta": "Envoie‑moi le fait et l’énigme d’aujourd’hui",
            "form.gdprNote": "Après avoir confirmé ton e‑mail, tu recevras chaque jour ou chaque semaine des faits et des énigmes de SwingPuzzles. Tu peux te désinscrire quand tu veux.",
            "video.heading": "Vois comment ça marche en 30 secondes",
            "video.fallback": "Ton navigateur ne prend pas en charge la balise vidéo.",
            "video.caption": "Exemple : d’abord un fait amusant à l’écran, puis une petite énigme à résoudre.",
            "video.cta": "Recevoir le fait et l’énigme d’aujourd’hui",
            "steps.heading": "Comment ça marche",
            "steps.1.title": "On t’envoie un petit fait surprenant",
            "steps.1.body": "Tu reçois dans ta boîte mail un nouveau fait qui éveille ta curiosité et rend ta journée plus intéressante.",
            "steps.2.title": "Tu résous une mini énigme liée au fait",
            "steps.2.body": "Une énigme rapide, directement liée au fait que tu viens de découvrir, pour le retenir plus facilement et en t’amusant.",
            "steps.3.title": "Tu t’offres un reset mental d’1 minute",
            "steps.3.body": "Tu passes brièvement du mode stress au mode jeu, avec une courte pause cérébrale qui te laisse plus détendu.",
            ...
            "finalCta.heading": "Prêt pour ta prochaine pause d’1 minute ?",
            "finalCta.primaryCta": "Recevoir le fait et l’énigme d’aujourd’hui",
            "footer.brand": "SwingPuzzles",
        ...
        it: {
            ...
            "title.main": "SwingPuzzles – Il tuo rompicapo quotidiano da 1 minuto",
            "hero.mascotAlt": "Mascotte di SwingPuzzles",
            "hero.heading": "Il tuo fatto e rompicapo quotidiano da 1 minuto",
            "hero.subheading": "Prima un fatto breve e sorprendente, poi un piccolo rompicapo collegato. Un rapido reset mentale per la tua giornata.",
            "hero.primaryCta": "Voglio il fatto e il rompicapo di oggi",
            "hero.note": "Gratis. Niente spam. Puoi annullare l’iscrizione quando vuoi.",
            "form.heading": "Ricevi oggi il tuo primo fatto + rompicapo",
            ...
            "form.submitCta": "Mandami il fatto e il rompicapo di oggi",
            "form.gdprNote": "Dopo aver confermato la tua e‑mail, riceverai e‑mail quotidiane o settimanali con fatti e rompicapi da SwingPuzzles. Puoi annullare l’iscrizione in qualsiasi momento.",
            "video.heading": "Guarda come funziona in 30 secondi",
            "video.fallback": "Il tuo browser non supporta il tag video.",
            "video.caption": "Un esempio: prima un fatto curioso sullo schermo, poi un piccolo rompicapo da risolvere.",
            "video.cta": "Voglio il fatto e il rompicapo di oggi",
            ...
            "steps.2.title": "Risolvi un piccolo rompicapo collegato al fatto",
            "steps.2.body": "Un enigma veloce collegato a quello che hai appena letto, così il fatto ti resta più impresso ed è più divertente.",
            ...
            "finalCta.primaryCta": "Voglio il fatto e il rompicapo di oggi",
            "footer.brand": "SwingPuzzles",
        ...
        cs: {
            ...
            "form.heading": "Dnes dostaneš svůj první fakt s hádankou",
            ...
            "form.submitCta": "Pošli mi dnešní fakt a hádanku",
            "form.gdprNote": "Po potvrzení e‑mailu ti začnou chodit denní nebo týdenní e‑maily s fakty a hádankami od SwingPuzzles. Odhlásit se můžeš kdykoliv.",
            "video.heading": "Podívej se, jak to funguje – za 30 sekund",
            "video.fallback": "Tvůj prohlížeč nepodporuje značku video.",
            "video.caption": "Ukázka: nejdřív zábavný fakt na obrazovce, potom maličká hádanka k němu.",
            "video.cta": "Chci dnešní fakt a hádanku",
            ...
            "steps.2.title": "Vyřešíš drobnou hádanku navázanou na fakt",
            "steps.2.body": "Rychlá úloha, která se vztahuje k tomu, co ses právě dozvěděl, takže si fakt lépe zapamatuješ a víc si ho užiješ.",
            ...
            "finalCta.primaryCta": "Chci dnešní fakt a hádanku",
            "footer.brand": "SwingPuzzles",
