(function () {
    const translations = {
        ...
        sk: {
            "meta.description": "SwingPuzzles – minútové denné fakty a puzzle. Najprv krátky prekvapivý fakt, potom malé puzzle na vyriešenie. Rýchly mentálny refresh pre tvoj deň.",
            "title.main": "SwingPuzzles – Tvoje 1-minútové puzzle na každý deň",
            "hero.mascotAlt": "Maskot SwingPuzzles",
            "hero.heading": "Tvoj denný 1-minútový fakt s puzzle",
            "hero.subheading": "Najprv krátky prekvapivý fakt, potom malé puzzle k nemu. Rýchly mentálny reset pre tvoj deň.",
            "hero.primaryCta": "Chcem dnešný fakt a puzzle",
            "hero.note": "Zdarma. Bez spamu. Odhlásiť sa môžeš kedykoľvek.",
            "form.heading": "Dnes dostaneš svoj prvý fakt s puzzle",
            "form.name.label": "Meno (voliteľné)",
            "form.name.placeholder": "Voliteľné – pre osobnejší e-mail",
            "form.email.label": "E-mailová adresa *",
            "form.email.placeholder": "ty@example.com",
            "form.submitCta": "Pošli mi dnešný fakt a puzzle",
            "form.gdprNote": "Po potvrdení e-mailu ti začnú chodiť denné alebo týždenné e-maily s faktmi a puzzle od SwingPuzzles. Odhlásiť sa môžeš kedykoľvek.",
            "video.heading": "Pozri sa, ako to funguje – za 30 sekúnd",
            "video.fallback": "Tvoj prehliadač nepodporuje značku video.",
            "video.caption": "Príklad: najprv zábavný fakt na obrazovke, potom malé puzzle k nemu.",
            "video.cta": "Chcem dnešný fakt a puzzle",
            ...
            "steps.2.title": "Vyriešiš malé puzzle nadviazané na fakt",
            "steps.2.body": "Rýchle puzzle, ktoré súvisí s tým, čo si sa práve dozvedel – vďaka tomu si fakt ľahšie zapamätáš a viac ťa to baví.",
            ...
            "finalCta.primaryCta": "Chcem dnešný fakt a puzzle",
            "footer.brand": "SwingPuzzles",
            "footer.tagline": "Denné fakty a puzzle pre každého",
            ...
            "success.message": "Skontroluj svoju schránku a potvrď prihlásenie. Čoskoro ti pošleme tvoj prvý fakt a puzzle!"
        }        
    };
